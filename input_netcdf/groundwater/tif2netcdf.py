...
class ConvertMapsToNetCDF4():
    def __init__(self, attribute=None):
        ...
        if attribute == None:
            ...
            self.attributeDictionary['title'] = "Specific yield"
            self.attributeDictionary['description'] = 'specific yield from  porosity_1km_GLHYMPS'
        else:
...
inDir = "P:/watmodel/CWATM/cwatm_input_1km_ebro/input_netcdf/groundwater/"

outDir = "P:/watmodel/CWATM/cwatm_input_1km_ebro/input_netcdf/groundwater/"
netcdfOut =outDir + "Europe_porosity_1km_GLHYMPS.nc"

inName = inDir+"Europe_porosity_1km_GLHYMPS1.tif"

varShortNames = ['yield']
varLongNames = ['specific yield']
